...
export default function OperacaoNova() {
  ...
  async function handleSubmit() {
    ...
    if (!status) return Alert.alert('Validação', 'Status é obrigatório')
    setSaving(true)
    try {
      const externalId = generateExternalId()
      await database.write(async () => {
        await database.get<Operacao>('operacoes').create((o: any) => {
          o._raw.external_id = externalId
          o._raw.server_id = null
